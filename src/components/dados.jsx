...
const dados = [
    ...
    },
    {
        ...
        date: "2024-11-15",
        content: "A SOS Mata Atlântica lançou uma nova iniciativa para proteger a fauna ameaçada de extinção na região do bioma Mata Atlântica. O projeto busca voluntários para monitoramento de espécies e doações para a construção de novos abrigos naturais.",
    ...
    },
    {
        ...
        date: "2024-10-30",
        content: "O Instituto Ayrton Senna anunciou uma parceria com redes municipais de ensino para implementar programas de desenvolvimento socioemocional em 300 escolas pelo Brasil. O objetivo é melhorar o desempenho acadêmico e reduzir a evasão escolar.",
    ...
    },
    {
        ...
        date: "2024-11-01",
        content: "A WWF Brasil está liderando um projeto de reflorestamento na Amazônia, com foco na recuperação de áreas degradadas e promoção de agricultura sustentável. Já foram plantadas mais de 1 milhão de mudas, beneficiando comunidades locais e protegendo o ecossistema.",
    ...
    },
    {
        ...
        date: "2024-10-25",
        content: "O Instituto Maria da Penha está organizando um seminário sobre os direitos das mulheres no Brasil, com foco na prevenção da violência doméstica e no fortalecimento de políticas públicas. O evento contará com palestras de especialistas e autoridades.",
    ...
    },
    {
        ...
        date: "2024-11-10",
        content: "Médicos Sem Fronteiras lançou uma campanha para angariar fundos e levar atendimento médico a crianças em situação de vulnerabilidade em regiões de conflito. A cada doação, vidas estão sendo salvas com medicamentos, vacinas e cuidados essenciais.",
